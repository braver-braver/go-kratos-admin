...
func newSysUser(db *gorm.DB) sysUser {
	...
	_sysUser.PositionID = field.NewInt64(tableName, "position_id")
	_sysUser.WorkID = field.NewInt64(tableName, "work_id")
...
type sysUser struct {
	...
	WorkID        field.Int64  // 员工工号
	RoleIds       field.String // 角色ID列表
...
func (s *sysUser) updateTableName(table string) *sysUser {
	...
	s.WorkID = field.NewInt64(table, "work_id")
