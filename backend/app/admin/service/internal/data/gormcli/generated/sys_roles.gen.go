...
func newSysRole(db *gorm.DB) sysRole {
	...
	_sysRole.DeletedBy = field.NewInt64(tableName, "deleted_by")
	_sysRole.Remark = field.NewString(tableName, "remark")
	_sysRole.SortOrder = field.NewInt32(tableName, "sort_order")
	...
	_sysRole.Menus = field.NewString(tableName, "menus")
	_sysRole.Apis = field.NewString(tableName, "apis")
...
func (s *sysRole) updateTableName(table string) *sysRole {
	...
	s.Menus = field.NewString(table, "menus")
	s.Apis = field.NewString(table, "apis")
