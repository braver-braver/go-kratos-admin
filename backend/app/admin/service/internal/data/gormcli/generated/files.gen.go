...
func newFile(db *gorm.DB) file {
	...
	_file.CreatedBy = field.NewInt64(tableName, "created_by")
	_file.UpdatedBy = field.NewInt64(tableName, "updated_by")
	_file.DeletedBy = field.NewInt64(tableName, "deleted_by")
	_file.Remark = field.NewString(tableName, "remark")
	_file.TenantID = field.NewInt64(tableName, "tenant_id")
	_file.Provider = field.NewString(tableName, "provider")
	_file.BucketName = field.NewString(tableName, "bucket_name")
	_file.FileDirectory = field.NewString(tableName, "file_directory")
	_file.FileGUID = field.NewString(tableName, "file_guid")
	_file.SaveFileName = field.NewString(tableName, "save_file_name")
	...
	_file.SizeFormat = field.NewString(tableName, "size_format")
	_file.LinkURL = field.NewString(tableName, "link_url")
...
type file struct {
	...
	Provider      field.String // OSS供应商
	BucketName    field.String // 存储桶名称
	FileDirectory field.String // 文件目录
	FileGUID      field.String // 文件Guid
	SaveFileName  field.String // 保存文件名
	FileName      field.String // 文件名
	Extension     field.String // 文件扩展名
	Size          field.Int64  // 文件字节长度
	SizeFormat    field.String // 文件大小格式化
	LinkURL       field.String // 链接地址
	Md5           field.String // md5码，防止上传重复文件
...
func (f *file) updateTableName(table string) *file {
	...
	f.DeletedBy = field.NewInt64(table, "deleted_by")
	f.Remark = field.NewString(table, "remark")
	f.TenantID = field.NewInt64(table, "tenant_id")
	f.Provider = field.NewString(table, "provider")
	f.BucketName = field.NewString(table, "bucket_name")
	f.FileDirectory = field.NewString(table, "file_directory")
	f.FileGUID = field.NewString(table, "file_guid")
	f.SaveFileName = field.NewString(table, "save_file_name")
	f.FileName = field.NewString(table, "file_name")
	f.Extension = field.NewString(table, "extension")
	f.Size = field.NewInt64(table, "size")
	f.SizeFormat = field.NewString(table, "size_format")
	f.LinkURL = field.NewString(table, "link_url")
...
func (f *file) fillFieldMap() {
	...
	f.fieldMap["provider"] = f.Provider
	f.fieldMap["bucket_name"] = f.BucketName
	f.fieldMap["file_directory"] = f.FileDirectory
	f.fieldMap["file_guid"] = f.FileGUID
	f.fieldMap["save_file_name"] = f.SaveFileName
	f.fieldMap["file_name"] = f.FileName
	f.fieldMap["extension"] = f.Extension
	f.fieldMap["size"] = f.Size
	f.fieldMap["size_format"] = f.SizeFormat
	f.fieldMap["link_url"] = f.LinkURL
