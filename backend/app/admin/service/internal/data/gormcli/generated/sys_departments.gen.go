...
func newSysDepartment(db *gorm.DB) sysDepartment {
	...
	_sysDepartment.CreatedBy = field.NewInt64(tableName, "created_by")
	_sysDepartment.UpdatedBy = field.NewInt64(tableName, "updated_by")
	_sysDepartment.DeletedBy = field.NewInt64(tableName, "deleted_by")
	_sysDepartment.SortOrder = field.NewInt32(tableName, "sort_order")
	_sysDepartment.Remark = field.NewString(tableName, "remark")
	_sysDepartment.TenantID = field.NewInt64(tableName, "tenant_id")
	_sysDepartment.Name = field.NewString(tableName, "name")
	_sysDepartment.OrganizationID = field.NewInt64(tableName, "organization_id")
	_sysDepartment.ManagerID = field.NewInt64(tableName, "manager_id")
