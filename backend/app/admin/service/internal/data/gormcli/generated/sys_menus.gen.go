...
type sysMenu struct {
	...
	Status    field.String // 菜单状态
	Type      field.String // 菜单类型 FOLDER: 目录 MENU: 菜单 BUTTON: 按钮 EMBEDDED: 内嵌 LINK: 外链
	Path      field.String // 路径,当其类型为'按钮'的时候对应的数据操作名,例如:/user.service.v1.UserService/Login
	Redirect  field.String // 重定向地址
	Alias     field.String // 路由别名
...
func (s *sysMenu) updateTableName(table string) *sysMenu {
	...
	s.Alias = field.NewString(table, "alias")
