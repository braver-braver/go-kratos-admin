...
func newSysRoleDept(db *gorm.DB) sysRoleDept {
	_sysRoleDept := sysRoleDept{}

	_sysRoleDept.sysRoleDeptDo.UseDB(db)
	...
	_sysRoleDept.CreatedAt = field.NewTime(tableName, "created_at")
	_sysRoleDept.UpdatedAt = field.NewTime(tableName, "updated_at")
	_sysRoleDept.DeletedAt = field.NewField(tableName, "deleted_at")
	_sysRoleDept.CreatedBy = field.NewInt64(tableName, "created_by")
	_sysRoleDept.UpdatedBy = field.NewInt64(tableName, "updated_by")
	_sysRoleDept.DeletedBy = field.NewInt64(tableName, "deleted_by")
