...
func newSysDictType(db *gorm.DB, opts ...gen.DOOption) sysDictType {
	...
	_sysDictType.TenantID = field.NewInt64(tableName, "tenant_id")
	_sysDictType.SortOrder = field.NewInt16(tableName, "sort_order")
	_sysDictType.DeletedBy = field.NewInt32(tableName, "deleted_by")
