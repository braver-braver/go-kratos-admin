...
func newDepartment(db *gorm.DB, opts ...gen.DOOption) department {
	...
	_department.ID = field.NewInt32(tableName, "id")
	_department.CreatedAt = field.NewTime(tableName, "created_at")
	_department.UpdatedAt = field.NewTime(tableName, "updated_at")
	_department.DeletedAt = field.NewTime(tableName, "deleted_at")
	_department.Status = field.NewString(tableName, "status")
	_department.CreateBy = field.NewInt64(tableName, "create_by")
	_department.UpdateBy = field.NewInt64(tableName, "update_by")
	_department.Remark = field.NewString(tableName, "remark")
	_department.TenantID = field.NewInt64(tableName, "tenant_id")
	_department.Name = field.NewString(tableName, "name")
	_department.OrganizationID = field.NewInt64(tableName, "organization_id")
	_department.SortID = field.NewInt32(tableName, "sort_id")
	_department.ParentID = field.NewInt32(tableName, "parent_id")
...
func (d *department) updateTableName(table string) *department {
	...
	d.SortID = field.NewInt32(table, "sort_id")
