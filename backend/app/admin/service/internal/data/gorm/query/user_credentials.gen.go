...
func newUserCredential(db *gorm.DB, opts ...gen.DOOption) userCredential {
	...
	_userCredential.ID = field.NewInt32(tableName, "id")
	_userCredential.CreatedAt = field.NewTime(tableName, "created_at")
	_userCredential.UpdatedAt = field.NewTime(tableName, "updated_at")
	_userCredential.DeletedAt = field.NewTime(tableName, "deleted_at")
	_userCredential.TenantID = field.NewInt64(tableName, "tenant_id")
	_userCredential.UserID = field.NewInt64(tableName, "user_id")
	_userCredential.IdentityType = field.NewString(tableName, "identity_type")
	_userCredential.Identifier = field.NewString(tableName, "identifier")
	_userCredential.CredentialType = field.NewString(tableName, "credential_type")
	_userCredential.Credential = field.NewString(tableName, "credential")
	_userCredential.IsPrimary = field.NewBool(tableName, "is_primary")
	_userCredential.Status = field.NewString(tableName, "status")
	_userCredential.ExtraInfo = field.NewString(tableName, "extra_info")
	_userCredential.ActivateToken = field.NewString(tableName, "activate_token")
	_userCredential.ResetToken = field.NewString(tableName, "reset_token")
...
type userCredential struct {
	...
	ActivateToken  field.String // 激活账号用的令牌
	ResetToken     field.String // 重置密码用的令牌
...
func (u *userCredential) updateTableName(table string) *userCredential {
	...
	u.IdentityType = field.NewString(table, "identity_type")
	u.Identifier = field.NewString(table, "identifier")
	u.CredentialType = field.NewString(table, "credential_type")
	...
	u.ExtraInfo = field.NewString(table, "extra_info")
	u.ActivateToken = field.NewString(table, "activate_token")
	u.ResetToken = field.NewString(table, "reset_token")
...
func (u *userCredential) fillFieldMap() {
	...
	u.fieldMap["credential_type"] = u.CredentialType
	u.fieldMap["credential"] = u.Credential
	u.fieldMap["is_primary"] = u.IsPrimary
	u.fieldMap["status"] = u.Status
	u.fieldMap["extra_info"] = u.ExtraInfo
	u.fieldMap["activate_token"] = u.ActivateToken
	u.fieldMap["reset_token"] = u.ResetToken
}
