...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.OrgID = field.NewInt64(tableName, "org_id")
	_user.PositionID = field.NewInt64(tableName, "position_id")
	_user.WorkID = field.NewInt64(tableName, "work_id")
	_user.Role = field.NewString(tableName, "roles")
...
func (u *user) updateTableName(table string) *user {
	...
	u.OrgID = field.NewInt64(table, "org_id")
	u.PositionID = field.NewInt64(table, "position_id")
	u.WorkID = field.NewInt64(table, "work_id")
